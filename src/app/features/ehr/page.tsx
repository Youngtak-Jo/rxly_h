            ...
            <main className="pt-32 pb-24 px-6 md:px-10 max-w-5xl mx-auto">
                <header className="mb-16 max-w-2xl">
                    <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-full bg-violet-50 border border-violet-100/50">
                        ...
                        <span className="text-xs font-semibold uppercase tracking-wider text-violet-800">{t("badge")}</span>
                    </div>
                ...
                <section className="mb-20">
                    <h2 className="text-2xl font-serif text-black mb-8 border-b border-black/[0.08] pb-4">{t("workflowTitle")}</h2>
                    <div className="grid md:grid-cols-3 gap-6 relative">
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-black/[0.08] shadow-sm text-center">
                            ...
                            <h3 className="font-semibold text-black mb-2">{t("workflow.review.title")}</h3>
                            <p className="text-sm text-gray-500 leading-relaxed">{t("workflow.review.description")}</p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-black/[0.08] shadow-sm text-center">
                            ...
                            <h3 className="font-semibold text-black mb-2">{t("workflow.staging.title")}</h3>
                            <p className="text-sm text-gray-500 leading-relaxed">{t("workflow.staging.description")}</p>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-black/[0.08] shadow-sm text-center">
                            ...
                            <h3 className="font-semibold text-black mb-2">{t("workflow.dispatch.title")}</h3>
                            <p className="text-sm text-gray-500 leading-relaxed">{t("workflow.dispatch.description")}</p>
                        </div>
                    </div>
                </section>
                ...
                {/* Mapped Resources */}
                <section>
                    <h2 className="text-2xl font-serif text-black mb-8 border-b border-black/[0.08] pb-4">{t("resourcesTitle")}</h2>
